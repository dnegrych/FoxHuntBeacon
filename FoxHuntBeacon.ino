...
This transmits a long tone, followed by a call sign in morse code.
It then waits an specified length of time then transmits it again.
Controls transmissions by connecting to a radio's ptt and mic input.
